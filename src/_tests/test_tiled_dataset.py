...
# TODO: Test qlty cropping within tiled_dataset. Since this part has been moved to the training script and performed outside, this is not on higher priority.
